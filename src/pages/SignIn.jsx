...
const SignIn = () => {
    ...
    return (
        <div className="mx-auto bg-gray-700 my-10 w-full max-w-md p-8 space-y-3 text-white rounded-xl">
            ...
            <form onSubmit={handleSubmit} noValidate="" action="" className="space-y-6">
                <div className="space-y-1 text-sm">
                    ...
                    <input type="email" ref={emailRef} name="email" id="username" placeholder="Email" className="outline outline-white w-full px-4 py-3 rounded-md dark:border-gray-300 dark:bg-gray-50 dark:text-gray-800 focus:dark:border-violet-600" />
                </div>
                <div className="space-y-1 text-sm">
            ...
            <p className="text-xs text-center sm:px-6">Don't have an account?
                <Link to="/signup" rel="noopener noreferrer" href="#" className="underline ml-1">Sign Up</Link>
            </p>
        </div>
    );
};
