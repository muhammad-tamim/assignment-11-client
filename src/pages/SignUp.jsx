        ...
        <>
            ...
            <div className="my-10 w-full max-w-md  space-y-3  mt-40 border border-white rounded-lg shadow-md p-4  mx-auto hover:shadow-lg hover:scale-[1.03] transition-transform duration-300 ease-in-out cursor-pointer">
                ...
                <div className="flex justify-center space-x-4">
                    <button onClick={() => handleGoogleSubmit()} aria-label="Log in with Google" className="p-3 rounded-sm cursor-pointer">
                ...
                <p className="text-xs text-center sm:px-6">Already have an account?
                    <Link to="/signin" rel="noopener noreferrer" href="#" className="underline ml-1 hover:text-primary">Sign In</Link>
                </p>
            </div>
        </>
    );
