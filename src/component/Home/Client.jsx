...
const industryLeaders = [
    {
        ...
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="fill-current w-14 h-14">
                {/* Paste your first SVG path here */}
        ...
        content: "Trusted by industry leaders for innovation and quality.",
    },
    // Add other companies with their icons and content here following the same structure
];

export default function IndustryLeadersSlider() {
    return (
        <section className="p-6 dark:bg-gray-100 dark:text-gray-800">
            <div className="container p-4 mx-auto text-center">
                <h2 className="text-4xl font-bold mb-8">Trusted by the industry leaders</h2>
            </div>
            <Swiper
                modules={[Autoplay]}
                spaceBetween={30}
            ...
            >
                {industryLeaders.map(({ title, icon, content }, idx) => (
                    <SwiperSlide key={idx} className="flex flex-col items-center p-4 bg-white rounded-lg shadow-md dark:bg-gray-50 dark:text-gray-800">
