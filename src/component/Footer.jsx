...
const Footer = () => {
    return (
        <footer className="max-w-screen-2xl mx-auto footer shadow footer-horizontal footer-center p-10 ">
            ...
            <div>
                <h1 className="text-2xl xl:text-4xl mb-2">Contact Info:</h1>
                <ul className="text-base xl:text-lg space-y-1">
                    <li>Email: <a href="mailto:support@recipebook.com">support@repidride.com</a></li>
